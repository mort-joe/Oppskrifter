...
function App() {
  ...
  const [isRecipeInstructionsEditorOpen, setIsRecipeInstructionsEditorOpen] = useState(false)
  const [recipeInstructionsEditorDraft, setRecipeInstructionsEditorDraft] = useState('')
